...
def google_ads_to_bigquery():
    try:
        ...
        credentials = service_account.Credentials.from_service_account_file('ecocare-ads-data-26533bc415de.json')
        ...
        dataset_id = 'google_ads_dataset_id'
        table_id = 'google_ads_table_id'
